...
struct WeeklyPay {
    ...
    string fullName = " ";   // will be first and last name
};
...
int main() {
   ...
   double netEarning ;     // pay after taxes
   double earningTaxes;    // taxes on earnings
   int healthIns = 130;   // health insurance 
    
    cout << "Please enter you first and Last name ";
   getline(cin, wagePaid.fullName );       // get names
   ...
   cout << " Your gross weekly earnings are $" << grossEarnings << endl;
    ...
    netEarning = (grossEarnings - healthIns) - earningTaxes ; // weekly net earnings
