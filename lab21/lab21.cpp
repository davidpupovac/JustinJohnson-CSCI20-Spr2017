...
int main (){
    ...
    cin >> windSpeed; 
    sqrtWind = sqrt(windSpeed);
    
    oldstyle = 0.081 * (3.71 * sqrtWind + 5.81 - 0.25 * windSpeed) * (tempF - 91.4) + 91.4; 
   cout << "The old style formula for wind chill produced " << endl;
    cout << oldstyle << endl;
    
    cout << " and the new style produced. " << endl;
    powWind = pow(windSpeed, 0.16);
    newStyle = 35.74 + 0.6215 * tempF - 35.75 *  powWind + 0.4275 * tempF * powWind;
    cout << newStyle << endl;
    
    diffOfStyles = abs(oldstyle - newStyle);
    
    cout << "The differnce between the styles is " << endl; 
    cout << diffOfStyles << endl;
    cout << " " << endl;
    
    cout << "windSpeed:    Old formula:     New formula:      differnce:" << endl;
